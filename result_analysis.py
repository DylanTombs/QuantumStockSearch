...
plt.savefig("analysis/sharpe_diff_by_assets.png")
plt.close()
...
plt.ylabel("Time (s)")
plt.tight_layout()
plt.savefig("analysis/vqe_runtime_by_experiment.png")
plt.close()
...
plt.savefig("analysis/sharpe_heatmap.png")
plt.close()
...
plt.ylabel("Return")
plt.legend()
plt.savefig("analysis/risk_return_comparison.png")
plt.close()

print("Analysis complete. Visuals saved in analysis/")
